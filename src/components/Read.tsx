...
import Grid from "@mui/material/Grid"; // Utilisation de Grid2 pour éviter les erreurs de types
    ...
    <MKBox component="section" py={{ xs: 3, md: 12 }}>
      <Container>
        <Grid container alignItems="center" spacing={3}>
          {/* Colonne de Gauche : Texte et Lien */}
          {/* Avec Grid2, on utilise l'objet 'size' pour définir la largeur */}
          <Grid size={{ xs: 12, lg: 5 }}>
            ...
            >
              More about us
              <Icon sx={{ fontWeight: "bold" }} className="material-icons-round">arrow_forward</Icon>
            </MKTypography>
          </Grid>

          {/* Colonne de Droite : Liste de fonctionnalités */}
          <Grid 
            size={{ xs: 12, lg: 6 }} 
            offset={{ lg: "auto" }} // Remplace le ml: "auto" pour un centrage propre
            sx={{ mt: { xs: 6, lg: 0 } }}
          >
            <Stack spacing={1}>
              {/* Feature 1 */}
